...
export async function materializeBridgeInboundFiles({
  ...
  files,
  registerSessionFile,
}: { jarvisHome?: any; sessionId?: any; sessionPath?: any; files?: any[]; registerSessionFile?: any } = {}) {
  if (!files?.length) {
    return { sessionFiles: [], imageAttachmentPaths: [], displayAttachments: [] };
  }
  if (!jarvisHome) throw new Error("bridge inbound file materialization requires jarvisHome");
