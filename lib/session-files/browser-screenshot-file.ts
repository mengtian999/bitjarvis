...
export function browserScreenshotPath(jarvisHome, sessionPath, { base64, mimeType, sessionId = null }: { base64?: any; mimeType?: any; sessionId?: any } = {}) {
  return path.join(
    sessionFilesCacheDir(jarvisHome, { sessionId, sessionPath }),
...
export async function persistBrowserScreenshotFile({
  ...
  mimeType = "image/png",
  registerSessionFile,
}: { jarvisHome?: any; sessionId?: any; sessionPath?: any; base64?: any; mimeType?: string; registerSessionFile?: any } = {}) {
  if (typeof registerSessionFile !== "function") {
    throw new Error("browser screenshot requires registerSessionFile");
  }
  const filePath = browserScreenshotPath(jarvisHome, sessionPath, { base64, mimeType, sessionId });
