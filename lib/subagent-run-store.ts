...
const DEFERRED_RESULT_MESSAGE_TYPE = "jarvis-background-result";
const DEFERRED_RESULT_RECORD_TYPE = "jarvis-deferred-result";
  ...
  const text = typeof content === "string"
    ...
    : Array.isArray(content)
      ? content
        ...
        .join("")
      : "";
  const opening = /^<jarvis-background-result\b([^>]*)>/i.exec(text.trim());
