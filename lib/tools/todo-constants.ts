 ...
 *
 * 命名不对称说明：tool 名用 snake_case（todo_write），对齐 Jarvis built-in
...
/** Jarvis 内部 session 事件：用户手动完成并移除当前 todo group */
export const TODO_STATE_CUSTOM_TYPE = "jarvis.todo_state";
