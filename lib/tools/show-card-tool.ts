...
export function createShowCardTool() {
  return {
    ...
    description:
      ...
      "The code is rendered inside a sandboxed iframe with Jarvis's design system CSS variables pre-injected. " +
      "Do NOT include DOCTYPE, <html>, <head>, or <body> tags — just content fragments.\n" +
      "IMPORTANT: Call jarvis_card_guide before your first show_card call to load the design system.",
