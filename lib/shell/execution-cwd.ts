...
const ERROR_CODES = {
  invalid: "JARVIS_EXEC_CWD_INVALID",
  relative: "JARVIS_EXEC_CWD_RELATIVE",
  missing: "JARVIS_EXEC_CWD_MISSING",
  "not-directory": "JARVIS_EXEC_CWD_NOT_DIRECTORY",
};
...
/**
 * spawn 前的工作目录断言。确定性失败抛 JARVIS_EXEC_CWD_*；
