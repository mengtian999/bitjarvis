...
async function materializeDocxImages({
  ...
  if (!jarvisHome || !sessionPath || typeof recordFileOperation !== "function") {
  ...
  const dir = sessionFilesCacheDir(jarvisHome, { sessionId, sessionPath });
...
export function wrapReadOfficeMedia(tool, cwd, {
  ...
  getSessionIdForPath,
  recordFileOperation,
}: { jarvisHome?: any; getVisionBridge?: any; isVisionAuxiliaryEnabled?: any; getSessionPath?: any; getSessionIdForPath?: any; recordFileOperation?: any } = {}) {
