...
export const REMINDER_BLOCK_PREFIX = "[jarvis_reminder";
export const REMINDER_BLOCK_END = "[/jarvis_reminder]";
 ...
 */
export const REFERENCE_BLOCK_PREFIX = "[jarvis_reference]";
export const REFERENCE_BLOCK_END = "[/jarvis_reference]";
...
const REMINDER_HEADER_LINE_RE = /^\[jarvis_reminder(?: at \d{4}-\d{2}-\d{2} \d{2}:\d{2})?\]$/;
