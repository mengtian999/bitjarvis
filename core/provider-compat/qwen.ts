 ...
 *   - DashScope OpenAI-compatible 视频模型（Jarvis compat 声明 video，且 shared 层确认可走 video_url）
 *
 ...
 *   - utility 路径：Pi SDK 不参与（callText 直 fetch），jarvis 必须自己强制关思考
 ...
 *   - 或 jarvis 的 quirks 系统重构（known-models.json 数据格式变更）
 *
