...
import {
  ...
  withJarvisAudioInputCompat,
  withJarvisVideoInputCompat,
...
function buildModelOverride(modelEntry, modelDefaults = {}, executionHeaders = {}) {
  ...
  let finalOverride = video === true ? withJarvisVideoInputCompat(override, true) : override;
  finalOverride = audio === true ? withJarvisAudioInputCompat(finalOverride, true) : finalOverride;
...
function buildModelEntry(
  ...
  let mediaAwareEntry = video === true ? withJarvisVideoInputCompat(entry, true) : entry;
  mediaAwareEntry = audio === true ? withJarvisAudioInputCompat(mediaAwareEntry, true) : mediaAwareEntry;
