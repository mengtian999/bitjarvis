...
const mockState: any = {
  ...
  sessions: [],
  sessionLocatorsById: {},
  deskBasePath: '/Users/x/JARVIS-WorkSpace',
...
describe('SessionStatusCard', () => {
  beforeEach(() => {
    ...
    mockState.deskBasePath = '/Users/x/JARVIS-WorkSpace';
  ...
  it('点击文件夹加号后把授权目录写回当前 session', async () => {
    ...
    await waitFor(() => {
      expect(jarvisFetch).toHaveBeenCalledWith('/api/sessions/authorized-folders', expect.objectContaining({
        method: 'PATCH',
        body: JSON.stringify({
          path: '/s/a.jsonl',
          action: 'add',
