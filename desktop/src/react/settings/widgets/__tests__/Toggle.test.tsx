...
describe('Toggle', () => {
  it('renders on state when on=true', () => {
    ...
    const btn = container.querySelector('button.jarvis-toggle');
  ...
  it('does not fire onChange when clicked in loading state', () => {
    ...
    const btn = container.querySelector('button.jarvis-toggle') as HTMLButtonElement;
    fireEvent.click(btn);
  ...
  it('fires onChange with toggled value when on=true', () => {
    ...
    fireEvent.click(container.querySelector('button.jarvis-toggle')!);
