...
export function MemoryViewer() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('jarvis-view-memories', handler);
    return () => window.removeEventListener('jarvis-view-memories', handler);
  }, []);
  ...
  const loadMemories = async () => {
    ...
    try {
      ...
      const res = await jarvisFetch(`/api/memories?agentId=${aid}`);
