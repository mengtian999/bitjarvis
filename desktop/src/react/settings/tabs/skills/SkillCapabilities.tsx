...
export function SkillCapabilities({ installCfg }: SkillCapabilitiesProps) {
  ...
  return (
    <>
      ...
      {showGithubWarning && (
        <div className="jarvis-warning-overlay" onClick={() => setShowGithubWarning(false)}>
          <div className="jarvis-warning-box" onClick={(e) => e.stopPropagation()}>
            <h3 className="jarvis-warning-title">{t('settings.skills.fetchWarning.title')}</h3>
            <div className="jarvis-warning-body">
            ...
            <div className="jarvis-warning-actions">
              <button className="jarvis-warning-cancel" onClick={() => setShowGithubWarning(false)}>
                {t('common.cancel')}
              </button>
              <button className="jarvis-warning-confirm" onClick={confirmGithubFetch}>
      ...
      {showSafetyWarning && (
        <div className="jarvis-warning-overlay" onClick={() => setShowSafetyWarning(false)}>
          <div className="jarvis-warning-box" onClick={(e) => e.stopPropagation()}>
            <h3 className="jarvis-warning-title">{t('settings.skills.safetyWarning.title')}</h3>
            <div className="jarvis-warning-body">
            ...
            <div className="jarvis-warning-actions">
              <button className="jarvis-warning-cancel" onClick={() => setShowSafetyWarning(false)}>
                {t('common.cancel')}
              </button>
              <button className="jarvis-warning-confirm" onClick={async () => {
