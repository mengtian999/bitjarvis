...
export function SharingTab() {
  const [screenshotColor, setScreenshotColor] = useState(
    () => localStorage.getItem('jarvis-screenshot-color') || 'light'
  );
  const [screenshotWidth, setScreenshotWidth] = useState(
    () => localStorage.getItem('jarvis-screenshot-width') || 'mobile'
  );
        ...
        <SettingsGrid columns={3} className={styles['theme-options']}>
          {([
            ...
            <button
              ...
              style={{ background: bg }}
              onClick={() => { setScreenshotColor(key); localStorage.setItem('jarvis-screenshot-color', key); }}
            >
          ...
          {([
            ...
            return (
              <button
                ...
                onClick={() => { setScreenshotWidth(width); localStorage.setItem('jarvis-screenshot-width', width); }}
              >
