...
import { jarvisFetch, jarvisUrl, yuanFallbackAvatar } from '../../api';
            ...
            >
              <div className={styles['agent-card-inner']}>
                <img
                  ...
                  draggable={false}
                  src={agent.hasAvatar
                    ? jarvisUrl(`/api/agents/${agent.id}/avatar${agent.avatarRevision ? `?v=${encodeURIComponent(agent.avatarRevision)}` : ''}`)
