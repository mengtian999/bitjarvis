...
import { jarvisUrl, yuanFallbackAvatar } from '../../api';
    ...
    return (
      <>
        <img
          ...
          src={agent?.hasAvatar ? jarvisUrl(`/api/agents/${agent.id}/avatar?t=${ts}`) : yuanFallbackAvatar(agent?.yuan || 'jarvis')}
          onError={(e) => { (e.target as HTMLImageElement).src = yuanFallbackAvatar(agent?.yuan || 'jarvis'); }}
        />
