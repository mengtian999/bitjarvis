...
export async function requestMarkdownCoverGeneration({
  ...
  const res = await jarvisFetch('/api/desk/beautify/cover', {
    method: 'POST',
...
export async function applyMarkdownCoverImage({
  ...
  const res = await jarvisFetch('/api/desk/beautify/cover/apply', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
...
export async function applyMarkdownCoverPreset({
  ...
  const targetInput = { filePath, target } as MarkdownCoverTargetInput;
  const res = await jarvisFetch('/api/desk/beautify/cover/preset/apply', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      ...coverTargetBody(targetInput),
