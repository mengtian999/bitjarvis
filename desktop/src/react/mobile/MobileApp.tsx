...
const MOBILE_UPDATE_AVAILABLE_EVENT = 'jarvis-mobile-update-available';
const MOBILE_APPLY_UPDATE_EVENT = 'jarvis-mobile-apply-update';
...
export function MobileApp(): React.ReactElement {
  ...
  const [mobileUpdateAvailable, setMobileUpdateAvailable] = useState(() => window.__jarvisMobileUpdateAvailable === true);
  ...
  useEffect(() => {
    ...
    if (window.__jarvisMobileUpdateAvailable === true) setMobileUpdateAvailable(true);
  ...
  return (
    <main className="onboarding">
      <section className="onboarding-step active">
        ...
        <h1 className="onboarding-title">Bit Jarvis</h1>
