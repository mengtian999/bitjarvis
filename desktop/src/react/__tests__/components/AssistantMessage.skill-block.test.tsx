...
describe('AssistantMessage skill blocks', () => {
  ...
  it('opens the installed skill preview from the chat resource card', () => {
    const installedSkillSource = {
      ...
      baseDir: '/tmp/jarvis-fixture/.jarvis/skills/university-info',
      filePath: '/tmp/jarvis-fixture/.jarvis/skills/university-info/SKILL.md',
      editable: true,
      readonly: false,
    };
    ...
    expect(mocks.openSkillPreview).toHaveBeenCalledWith(
      'university-info',
      '/tmp/jarvis-fixture/.jarvis/skills/university-info/SKILL.md',
      installedSkillSource,
    );
  });
});
