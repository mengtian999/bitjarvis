...
vi.mock('../../settings/store', () => {
  const state = {
    agents: [
      { id: 'jarvis', name: 'Jarvis', yuan: 'jarvis', isPrimary: false },
      { id: 'primary', name: 'Primary', yuan: 'jarvis', isPrimary: true },
    ],
    getSettingsAgentId: () => 'jarvis',
...
describe('ExperimentsTab', () => {
  beforeEach(() => {
    ...
    jarvisFetchMock.mockImplementation(async (url: string, opts?: RequestInit) => {
