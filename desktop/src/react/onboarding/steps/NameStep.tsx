...
export function NameStep({ preview, jarvisFetch, agentId, verificationPlan, goToStep, showError }: NameStepProps) {
  ...
  }, [preview, jarvisFetch, agentId, userName, agentName, memoryEnabled, verificationPlan, goToStep, showError]);
