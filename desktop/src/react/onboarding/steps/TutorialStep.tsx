...
export function TutorialStep({ preview, jarvisFetch, agentId, verificationPlan, showError }: TutorialStepProps) {
  ...
  const onFinish = useCallback(async () => {
    ...
    setFinishing(true);
    try {
      await verifyOnboardingPersistence({ jarvisFetch, agentId, verificationPlan });
  ...
  }, [preview, jarvisFetch, agentId, verificationPlan, showError]);
