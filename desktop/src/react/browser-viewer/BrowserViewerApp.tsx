...
export function BrowserViewerApp() {
  ...
  useEffect(() => {
    ...
    // 监听主题切换
    jarvis?.onSettingsChanged?.((type: string, data: unknown) => {
      if (type === 'theme-changed' && isThemePayload(data)) setTheme(data.theme);
    });

    // 接收浏览器状态更新
    jarvis?.onBrowserUpdate?.((data: BrowserViewerUpdate) => {
      ...
      <div className="toolbar">
        <div className="toolbar-left">
          ...
          <button
            ...
            onClick={() => jarvis?.closeBrowserViewer?.()}
          >
          ...
          <button
            ...
            onClick={() => jarvis?.browserEmergencyStop?.(sessionPath)}
          >
          ...
          <button
            ...
            onClick={() => jarvis?.browserGoBack?.(sessionPath)}
          >
          ...
          <button
            ...
            onClick={() => jarvis?.browserGoForward?.(sessionPath)}
          >
            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button
            ...
            onClick={() => jarvis?.browserReload?.(sessionPath)}
          >
        ...
        <div className="browser-tab-strip">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  title={tabTitle(tab)}
                  onClick={() => jarvis?.browserSwitchTab?.(tab.tabId, sessionPath)}
                  onDoubleClick={() => jarvis?.browserCloseTab?.(tab.tabId, sessionPath)}
                >
                  ...
                  <span
                    ...
                    onClick={(event) => {
                      ...
                      jarvis?.browserCloseTab?.(tab.tabId, sessionPath);
                    }}
          ...
          <button
            ...
            onClick={() => jarvis?.browserNewTab?.(sessionPath)}
          >
            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round">
              <path d="M7 3v8M3 7h8" />
            </svg>
