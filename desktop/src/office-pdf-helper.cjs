...
const OFFICE_PDF_HELPER_FLAG = "--jarvis-office-html-to-pdf";
...
function normalizeJob(raw) {
  ...
  return {
    ...
    embedJarvisFonts: raw.embedJarvisFonts !== false,
...
async function renderJob(job) {
  ...
  const fontCss = job.embedJarvisFonts ? buildFontInjectionCss() : null;
