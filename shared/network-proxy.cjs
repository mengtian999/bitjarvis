...
// Only loopback endpoints are forced direct. Future remote Jarvis servers need a
...
function systemProxyConfigToEnvironment(resolved, baseEnv = process.env, config = {}) {
