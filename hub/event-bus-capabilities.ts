...
export const BUILTIN_EVENT_BUS_CAPABILITIES = Object.freeze([
  {
    ...
    description: "Create a detached Jarvis session, optionally owned and hidden by a plugin.",
  ...
  },
  {
    type: "session:get",
    title: "Get session",
    description: "Read one Jarvis session projection by path.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description: "Send text into a Jarvis session on behalf of a plugin.",
    inputSchema: {
      type: "object",
      properties: {
        text: { type: "string" },
  ...
  },
  {
    type: "agent:list",
    title: "List agents",
    description: "List configured Jarvis agents.",
    inputSchema: {
      type: "object",
      properties: {
        ownerPluginId: { type: "string" },
