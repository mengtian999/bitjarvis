...
- Open a private vulnerability report in the repository Security tab when available:
  https://github.com/mengtian999/Bitjarvis/security
...
(`JARVIS_HOME`, by default `~/.jarvis`). What the application guarantees:
...
- On Windows the guarantees above do not apply. NTFS does not implement POSIX
  ...
  standard accounts, but a data directory placed elsewhere through `JARVIS_HOME`
