...
export const description = "Return the Jarvis media generation guide: tool routing, parameter rules, and provider override policy for image and video generation.";
