...
export const description = [
  ...
  "Jarvis's bundled fonts (EB Garamond / Noto Serif SC / JetBrains Mono) are injected during rendering, so pages whose font stacks reference them get the real fonts embedded in the PDF; pages that don't reference them are unaffected.",
