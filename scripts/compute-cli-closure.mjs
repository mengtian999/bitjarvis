 ...
 * `jarvis` CLI + its spawned server composition need to distribute and run".
...
export const CLOSURE_ROOTS = Object.freeze([
  {
    ...
    reason:
      "Primary CLI entrypoint (package.json \"bin\": {\"jarvis\": \"cli/entry.ts\"}). "
  ...
  },
  {
    ...
    reason:
      ...
      + "JARVIS_SERVER_ENTRY all target server/main-full.ts instead, and "
...
export const DYNAMIC_CALL_ALLOWLIST = Object.freeze([
  {
    ...
    reason:
      "serverEntry is JARVIS_SERVER_ENTRY or a path.join() computed from JARVIS_ROOT; it "
